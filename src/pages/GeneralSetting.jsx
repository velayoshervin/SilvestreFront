...
const GeneralSetting = () => {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      setUser(parsedUser); // then update state
      setFormValues((prev) => ({
        firstname: parsedUser.firstname || "",
        lastname: parsedUser.lastname || "",
        email: parsedUser.email || "",
        phone: parsedUser.phone || "",
        enableEmailOtp: parsedUser.enableEmailOtp || false,
        enableSmsOtp: parsedUser.enableSmsOtp || false,
  ...
  return (
    <div className="max-w-[800px] mx-auto text-[16px]">
      <div className="">
        {/* <h1 className="text-xl font-semibold px-3 my-[8px]">
          General Settings
        </h1> */}
        ...
        {isEditing && (
          <div className="flex  justify-end gap-2 my-[16px]">
            <button
